...
ctx.prototype.__applyStyleToCurrentElement = function(type) {
  ...
  for (i = 0; i < keys.length; i++) {
    ...
    if(style.apply) {
      ...
      // this.__currentElement.setAttribute("class", format("{class}", {
      //   class: 'test'
      // }));
    }
  }

  this.__currentElement.setAttribute('id', this.globalCompositeOperation + '-' + parseInt(Math.random() * 100000));
};
...
ctx.prototype.getSerializedSvg = function(fixNamedEntities) {
  addStyleTo(this.__root, this.__document);
